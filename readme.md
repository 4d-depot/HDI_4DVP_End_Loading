# HDI_4DVP_End_Loading 

How do I know when a [4D View Pro](https://us.4d.com/4d-view-pro) document has finished loading? (4D v18 R6)

Find more information on the [blog post](https://blog.4d.com/4d-view-pro-end-of-document-loading/).
